...
with open ('./10-AnalisedeInsulina/10_preproinsulin-seq.txt', 'r') as arquivo:
...
with open('./10-AnalisedeInsulina/10a_preproinsulin-seq-clean.txt', 'w') as arquivo_limpo:
...
with open('./10-AnalisedeInsulina/10b_lsinsulin-seq-clean.txt', 'w') as arquivo:
...
with open('./10-AnalisedeInsulina/10d_cinsulin-seq-clean.txt', 'w') as arquivo:
...
with open('./10-AnalisedeInsulina/10e_ainsulin-seq-clean.txt', 'w') as arquivo:
